...
int main(){
    ...
    signed int value1 {10};     //"signed" lets you assign positive and negative integers
    ...
    unsigned int value3 {4};    //"unsigned" only lets you assign positive integers
    //unsigned int value4{-5}; // Compiler error because you are trying to assign negative
