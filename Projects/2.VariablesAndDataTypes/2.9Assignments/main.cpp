...
int main(){
    ...
    std::cout << std::boolalpha;        //this is used to force the system to use "true" or "false" term rather than the default "1" and "0"
...
var3 : 4294967274          //GARBAGE VALUE!! since you assign a negative number! Danger!
*/